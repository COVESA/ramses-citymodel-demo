...
public:
    ...
    virtual void createOptions(cxxopts::Options& options)
    {
        options.add_options()
            ...
            ("w,width", "Window width", cxxopts::value<uint32_t>(m_windowWidth)->default_value("1920"))
            ("h,height", "Window height", cxxopts::value<uint32_t>(m_windowHeight)->default_value("1080"))
