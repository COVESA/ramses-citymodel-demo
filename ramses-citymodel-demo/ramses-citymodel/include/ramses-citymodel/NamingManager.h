...
public:
     ...
     *  @param resourceFilePath File path for resources. */
    ...
    void update(const Matrix44& viewProjectionMatrix);
    ...
    bool projectCheckXY(const Vector3& p, Vector2& p2d, bool& xyVisible);
    ...
    bool project(const Vector3& p, Vector2& p2d);
...
protected:
    ...
    /// The RenderGroup used for text rendering.
