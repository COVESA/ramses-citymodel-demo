...
public:
    ...
    const Vector4& boundingPoint(uint32_t i) const;
    ...
    static Matrix44 GetWorldSpaceMatrixOfNode(ramses::Node& node);
    static Matrix44 GetObjectSpaceMatrixOfNode(ramses::Node& node);
