...
void CitymodelScene::setCarPos(const Vector3& carPos)
{
    m_carPosData->setValue(carPos.getX(), carPos.getY(), carPos.getZ());
}
...
std::vector<Vector3>& CitymodelScene::getNamePoints()
{
    return m_namePoints;
}

std::vector<Vector3>& CitymodelScene::getRoutePoints()
{
