...
AnimationPath::Key::Key(const Vector3& carPosition, const Vector3& carRotation)
    : m_carPosition(carPosition)
    , m_carRotation(carRotation)
{
}

const Vector3& AnimationPath::Key::getCarPosition()
{
    return m_carPosition;
}

const Vector3& AnimationPath::Key::getCarRotation()
{
